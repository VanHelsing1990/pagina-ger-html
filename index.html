...
<body>
						...
						<li class="has-children">
							...
							<ul class="dropdown">
								...
								<li class="has-children">
									<a href="#">Dropdown</a>
									<ul class="dropdown">
										<li><a href="administrador/sesion.php">inicio sesion</a></li>
		...
		<div class="container">
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-9 text-center">
					<h1 class="heading" data-aos="fade-up">Diseñaremos la casa de sus Sueños</h1>
	...
	<div class="section">
		<div class="container">
			<div class="row mb-5 align-items-center">
				<div class="col-lg-6">
					<h2 class="font-weight-bold text-primary heading">Diseños Populares</h2>
				</div>
				<div class="col-lg-6 text-lg-end">
					<p><a href="#" target="_blank" class="btn btn-primary text-white py-3 px-4">Todos los Diseños</a></p>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-12">
					...
					<div class="property-slider-wrap">
						...
						<div class="property-slider">
							...
							<div class="property-item">
								...
								<div class="property-content">
									...
									<div>
										<span class="d-block mb-2 text-black-50">5232 costanera, calle num 132.</span>
										<span class="city d-block mb-3">San Nicolas,Prov Bn As</span>

										<div class="specs d-flex mb-4">
											<span class="d-block d-flex align-items-center me-3">
												<span class="icon-bed me-2"></span>
												<span class="caption">2 piezas</span>
											</span>
										...
										<a href="property-single.php" class="btn btn-primary py-2 px-3">Mas Detalles</a>
									</div>
								</div>
							</div> <!-- .item -->
						...
						<div id="property-nav" class="controls" tabindex="0" aria-label="Carousel Navigation">
							<span class="prev" data-controls="prev" aria-controls="property" tabindex="-1">Atras</span>
			...
			<div class="row">
				...
				<div class="col-6 col-lg-3"  data-aos="fade-up" data-aos-delay="500">
					<div class="box-feature">
						...
						<h3 class="mb-3">Propiedades a la venta</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptates, accusamus.</p>
						<p><a href="#" class="learn-more">Learn More</a></p>
					</div>
				</div>
				...
				<div class="col-6 col-lg-3"  data-aos="fade-up" data-aos-delay="600">
					<div class="box-feature">
						...
						<h3 class="mb-3">Remodelaciones</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptates, accusamus.</p>
						<p><a href="#" class="learn-more">Learn More</a></p>
					</div>
				</div>	
	...
	<div class="section sec-testimonials">
		<div class="container">
			<div class="row mb-5 align-items-center">
				<div class="col-md-6">
					<h2 class="font-weight-bold heading text-primary mb-4 mb-md-0">Clientes Satisfechos</h2>
				</div>
	...
	<div class="section section-4 bg-light">
		<div class="container">
			<div class="row justify-content-center  text-center mb-5">
				<div class="col-lg-5">
					<h2 class="font-weight-bold heading text-primary mb-4">Encontremos tu hogar perfecto para ti</h2>
				...
				<div class="col-lg-4">
					<div class="d-flex feature-h">
						...
						<div class="feature-text">
							<h3 class="heading">2 dormitorios o mas?</h3>
					...
					<div class="d-flex feature-h">
						...
						<div class="feature-text">
							<h3 class="heading">Cuantas personas?</h3>
							<p class="text-black-50">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum iste.</p>   
						</div>
					</div>
					...
					<div class="d-flex feature-h">
						...
						<div class="feature-text">
							<h3 class="heading">Casa Asegurada</h3>
							<p class="text-black-50">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum iste.</p>   
						</div>
					</div>
				</div>
			...
			<div class="row section-counter mt-5">
				<div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
					<div class="counter-wrap mb-5 mb-lg-0">
						<span class="number"><span class="countup text-primary">20</span></span>
						<span class="caption text-black-50"># casas terminadas</span>
					</div>
				</div>
				<div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="400">
					<div class="counter-wrap mb-5 mb-lg-0">
						<span class="number"><span class="countup text-primary">50</span></span>
						<span class="caption text-black-50"># diseños Vendidos</span>
					</div>
				</div>
				<div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="500">
					<div class="counter-wrap mb-5 mb-lg-0">
						<span class="number"><span class="countup text-primary">40</span></span>
						<span class="caption text-black-50"># Rediseñadas</span>
					</div>
				</div>
				<div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="600">
					<div class="counter-wrap mb-5 mb-lg-0">
						<span class="number"><span class="countup text-primary">5</span></span>
						<span class="caption text-black-50"># Reparaciones</span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="section">
		<div class="row justify-content-center footer-cta" data-aos="fade-up">
			<div class="col-lg-7 mx-auto text-center">
				<h2 class="mb-4 ">Quieres vender o alquilar tu hogar?</h2>
				<p><a href="#" target="_blank" class="btn btn-primary text-white py-3 px-4">Escribenos y te ayudaremos </a></p>
			</div> <!-- /.col-lg-7 -->
		</div> <!-- /.row -->
	</div>
	<!-- nosotros----------------------------------------------->
